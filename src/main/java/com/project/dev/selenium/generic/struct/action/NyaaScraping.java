...
public class NyaaScraping extends Action {
    ...
    public boolean executeAction(@NonNull WebDriver driver, @NonNull WebElement element, Map<String, String> flagsMap, List<Object> scriptResults) throws Exception {
        excludedSeriesFilePath = Action.assignScriptResult(excludedSeriesFilePath, scriptResults);
        minTorrentsDate = Action.assignScriptResult(minTorrentsDate, scriptResults);
        domTableElementXpath = Action.assignScriptResult(domTableElementXpath, scriptResults);
        domTableElementTitleXpath = Action.assignScriptResult(domTableElementTitleXpath, scriptResults);
        domTableElementDateXpath = Action.assignScriptResult(domTableElementDateXpath, scriptResults);
        domTableElementDownloadButtonXpath = Action.assignScriptResult(domTableElementDownloadButtonXpath, scriptResults);
        delayTimeBeforeActions = Integer.parseInt(Action.assignScriptResult(delayTimeBeforeActions, scriptResults));
        delayTimeBeetweenDownloads = Integer.parseInt(Action.assignScriptResult(delayTimeBeetweenDownloads, scriptResults));
